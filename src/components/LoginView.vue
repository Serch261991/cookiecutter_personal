                    ...
                    <v-col cols="12" md="8">
                      <v-card-text class="mt-12">
                        ...
                        <v-row align="center" justify="center">
                          <v-col cols="6" md="6">
                            <v-form>
                            <v-text-field type="number" id="username" label="Ficha" v-model="form.username" color="teal accent-3"/>
                            <v-text-field type="password" id="password" label="Contraseña" v-model="form.password" color="teal accent-3"/>
                          </v-form>
                          </v-col>
                        </v-row>
                      </v-card-text>
                      <div class="text-center mt-3">
                        <v-btn rounded color="teal accent-3" dark type="submit" v-on:click.prevent="login()" style="background-color: #9e2244!important; border: #9e2244!important;">Iniciar sesión</v-btn>
                      </div>
                      <v-card-text>
                      </v-card-text>
                    </v-col>
